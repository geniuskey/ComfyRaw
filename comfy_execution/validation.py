...
# IO type constants (avoiding comfy_api import which requires torch)
_IO_TYPE_ANY = "*"
_IO_TYPE_MATCH = "COMFY_MATCHTYPE_V3"
_IO_TYPE_COMBO = "COMBO"
...
def validate_node_input(
    ...
    if received_type == _IO_TYPE_ANY or input_type == _IO_TYPE_ANY:
        return True
    ...
    if received_type == _IO_TYPE_MATCH or input_type == _IO_TYPE_MATCH:
        return True
    ...
    if isinstance(received_type, list) and input_type == _IO_TYPE_COMBO:
        return True
    ...
    if _IO_TYPE_ANY in received_types or _IO_TYPE_ANY in input_types:
        return True
