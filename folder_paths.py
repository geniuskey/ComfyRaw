...
# ComfyRaw - Simplified folder paths for image/video processing
# Supported image extensions
supported_image_extensions: set[str] = {'.png', '.jpg', '.jpeg', '.bmp', '.tiff', '.tif', '.webp', '.gif'}
# Supported video extensions
supported_video_extensions: set[str] = {'.mp4', '.avi', '.mov', '.mkv', '.webm', '.flv', '.wmv'}
...
# Workflows directory
folder_names_and_paths["workflows"] = ([os.path.join(base_path, "workflows")], {'.json'})
...
def map_legacy(folder_name: str) -> str:
    # No legacy mappings needed for ComfyRaw
    return folder_name
